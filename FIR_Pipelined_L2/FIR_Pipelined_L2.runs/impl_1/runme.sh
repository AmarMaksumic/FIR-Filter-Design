...
HD_PWD='C:/code/FIR-Filter-Design/FIR_Pipelined_L2/FIR_Pipelined_L2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log l2_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source l2_wrapper.tcl -notrace
