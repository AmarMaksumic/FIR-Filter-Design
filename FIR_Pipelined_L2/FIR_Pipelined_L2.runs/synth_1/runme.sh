...
HD_PWD='C:/code/FIR-Filter-Design/FIR_Pipelined_L2/FIR_Pipelined_L2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log l2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source l2_wrapper.tcl
