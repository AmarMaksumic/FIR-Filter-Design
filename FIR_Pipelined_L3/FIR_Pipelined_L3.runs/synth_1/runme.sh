...
HD_PWD='C:/code/FIR-Filter-Design/FIR_Pipelined_L3/FIR_Pipelined_L3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log l3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source l3_wrapper.tcl
